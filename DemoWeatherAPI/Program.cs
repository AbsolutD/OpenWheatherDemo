...
namespace DemoWeatherAPI
{
    class Program
    {
        ...
        static async Task RunAsnyc()
        {
            ...
            client.BaseAddress = new Uri("http://api.openweathermap.org/data/2.5/forecast"); // setup routhe prefix
            client.DefaultRequestHeaders.Accept.Clear();
            client.DefaultRequestHeaders.Accept.Add(
                new MediaTypeWithQualityHeaderValue("application/json")); // set default mediatypeformatter to JSON
    ...
    // https://www.getpostman.com/ Postman (to try out the HTTP request)
    // https://docs.microsoft.com/en-us/aspnet/web-api/overview/advanced/calling-a-web-api-from-a-net-client // Microsoft tutorial
    // http://people.inf.elte.hu/groberto/elte_waf/ Egyetemi tananyag
}
